...
namespace ConsoleApplication
{
    public class Program
    {
        ...
        private KeypadNr KeyA = new KeypadNr("A");
        private KeypadNr KeyB = new KeypadNr("B");
        private KeypadNr KeyC = new KeypadNr("C");
        private KeypadNr KeyD = new KeypadNr("D");
...
";
        ...
        private void SetKeyRelationships2() {
            Key1.DownNeighbour = Key3;

            Key2.RightNeighbour = Key3;
            Key2.DownNeighbour = Key6;

            Key3.UpNeighbour = Key1;
            Key3.RightNeighbour = Key4;
            ...
            Key6.UpNeighbour = Key2;
            Key6.RightNeighbour = Key7;
            Key6.DownNeighbour = KeyA;
            Key6.LeftNeighbour = Key5;

            Key7.UpNeighbour = Key3;
            Key7.RightNeighbour = Key8;
            Key7.DownNeighbour = KeyB;
            Key7.LeftNeighbour = Key6;

            Key8.UpNeighbour = Key4;
            Key8.RightNeighbour = Key9;
            Key8.DownNeighbour = KeyC;
            Key8.LeftNeighbour = Key7;

            Key9.LeftNeighbour = Key8;

            KeyA.UpNeighbour = Key6;
            KeyA.RightNeighbour = KeyB;

            KeyB.UpNeighbour = Key7;
            KeyB.RightNeighbour = KeyC;
            KeyB.DownNeighbour = KeyD;
            KeyB.LeftNeighbour = KeyA;
            
            KeyC.UpNeighbour = Key8;
            KeyC.LeftNeighbour = KeyB;
            
            KeyD.UpNeighbour = KeyB;
        } 
